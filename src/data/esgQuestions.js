...
// Schema bilingue (DE original + tradução PT). A complexidade vive aqui, nos
// dados — o formulário (Diagnostico.jsx) é genérico e renderiza por `type`.
//
// Tipos de resposta:
//   'boolean'   → Sim / Não
...
export const ESG_PILLARS = [
  ...
  {
    key: 'G', letter: 'G',
    pt: 'Governança', de: 'Unternehmensführung',
